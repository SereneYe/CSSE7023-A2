...
public class EqualTest {
    ...
    public void testIdentityValue() throws TypeError {
        ...
        assertEquals("Result of equal operator, with a single Constant, is incorrect.",
    ...
    public void testIdentityPerform() throws TypeError {
        ...
        assertEquals("Result of performing equal operator is incorrect.", 1, result);
    }
    ...
    public void testTwoValueTrue() throws TypeError {
        ...
        assertTrue("Result of evaluating equal is not a constant.",
                result instanceof Constant);
        assertEquals("Result of performing equal operator is incorrect.", 1, ((Constant) result).getValue());
    }
    ...
    public void testTwoValueFalse() throws TypeError {
        ...
        assertTrue("Result of evaluating equal is not a constant.",
                result instanceof Constant);
        assertEquals("Result of equal operator is incorrect.", 0, ((Constant) result).getValue());
    }
    ...
    public void testTwoPerformFalse() throws TypeError {
        ...
        assertEquals("Result of performing equal operator is incorrect.", 0, result);
    }
    ...
    public void testNValueTrue() throws TypeError {
        ...
        assertTrue("Result of evaluating equal is not a constant.",
                result instanceof Constant);
        assertEquals("Result of equal operator is incorrect.", 1, ((Constant) result).getValue());
    }
