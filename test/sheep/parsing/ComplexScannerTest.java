...
public class ComplexScannerTest {
    ...
    @Test
    public void testTokenizeNegativeEmptyParseException() throws ParseException {
        String input = "-()";
        List<ComplexScanner.Token> tokens = ComplexScanner.tokenize(input);
        assertEquals(2, tokens.size());
        assertToken(tokens.get(0), ComplexScanner.TokenType.OP, "-", null);
        assertToken(tokens.get(1), ComplexScanner.TokenType.FUNC, "", "");
    }

    @Test
    public void testTokenizeNegativeFunctionParseException() throws ParseException {
        String input = "-(-42)";
        List<ComplexScanner.Token> tokens = ComplexScanner.tokenize(input);
        assertEquals(2, tokens.size());
        assertToken(tokens.get(0), ComplexScanner.TokenType.OP, "-", null);
        assertToken(tokens.get(1), ComplexScanner.TokenType.FUNC, "", "-42");
    }

    @Test
    public void testTokenizeNegativeNegativeFunctionParseException() throws ParseException {
        String input = "-(-(-42))";
        List<ComplexScanner.Token> tokens = ComplexScanner.tokenize(input);
        assertEquals(2, tokens.size());
        assertToken(tokens.get(0), ComplexScanner.TokenType.OP, "-", null);
